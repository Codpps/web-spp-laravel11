 <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-semibold ms-2">Web SPP</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <!-- Components -->
            <li class="menu-header mt-7"><span class="menu-header-text">CMS SPP</span></li>
            <!-- Cards -->
            <li class="menu-item">
  <a href="{{ route('petugas.index') }}" class="menu-link">
    <i class="menu-icon tf-icons ri-user-2-line"></i> <!-- Ikon untuk Petugas -->
    <div data-i18n="Basic">Petugas</div>
  </a>
</li>
<li class="menu-item">
  <a href="{{ route('siswa.index') }}" class="menu-link">
    <i class="menu-icon tf-icons ri-user-3-line"></i> <!-- Ikon untuk Siswa -->
    <div data-i18n="Basic">Siswa</div>
  </a>
</li>
<li class="menu-item">
  <a href="{{ route('kelas.index') }}" class="menu-link">
    <i class="menu-icon tf-icons ri-door-open-line"></i> <!-- Ikon untuk Kelas -->
    <div data-i18n="Basic">Kelas</div>
  </a>
</li>
<li class="menu-item">
  <a href="{{ route('spp.index') }}" class="menu-link">
    <i class="menu-icon tf-icons ri-money-dollar-circle-line"></i> <!-- Ikon untuk SPP -->
    <div data-i18n="Basic">SPP</div>
  </a>
</li>
<li class="menu-item">
  <a href="cards-basic.html" class="menu-link">
    <i class="menu-icon tf-icons ri-wallet-3-line"></i> <!-- Ikon untuk Pembayaran -->
    <div data-i18n="Basic">Pembayaran</div>
  </a>
</li>
<li class="menu-item">
  <a href="history.html" class="menu-link">
    <i class="menu-icon tf-icons ri-time-line"></i> <!-- Ikon untuk History -->
...
<li class="menu-item">
  <a href="cards-basic.html" class="menu-link">
    <i class="menu-icon tf-icons ri-file-list-3-line"></i> <!-- Ikon untuk Laporan -->
